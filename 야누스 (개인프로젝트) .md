...
### 6. 설계자 혹은 최고권한자의 사회적 직위 박탈 시
- 설계자 혹은 최고권한자가 경영권 박탈, 해고 등 야누스 시스템이 적용된 기업에서 탈락할 시
> 설계자는 이제부터 모든 정보를 거지고 있는 공격자 포지션으로 변경
...
## 프로젝트를 만든 궁극적인 이유
- 친했던 형이 내부고발자로 낙인 후 자살
- 시스템이 어떻게 내부고발자를 찾아내고 제거하는지 그 시스템이 궁금해짐
- 그 시스템을 분석하여 내가 구현해보고 싶음
